...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo+Black&family=Bebas+Neue&family=Inter:wght@400;500;600;700&family=Poppins:wght@400;600;700;800&family=Work+Sans:wght@400;500&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
