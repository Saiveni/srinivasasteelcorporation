  ...
  return (
    <section className="py-14 bg-white border-y border-black/5 overflow-hidden">
      <div className="container-wide">
        ...
        >
          <span className="text-[#C5A059] text-[11px] font-body font-bold tracking-[0.4em] uppercase mb-4 block">
        ...
        <div className="flex flex-wrap items-center justify-center gap-12 lg:gap-32">
          {brands.map((brand, idx) => (
            ...
            >
              ...
              <div className="text-[9px] font-body font-bold text-[#C5A059]/60 tracking-[0.2em] uppercase">
                {brand.subtitle}
              </div>
            </motion.div>
          ))}
