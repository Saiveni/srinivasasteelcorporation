          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              <div className="space-y-6 text-[#4A5568] text-base lg:text-lg leading-relaxed font-[450]">
                ...
                <p>
                  We are a steel supplier specializing in TMT rebars, steel wire products, and oil rods. With a strong regional presence across Vijayawada, Vizag, and Gannavaram, we serve the construction and industrial sectors with professional integrity.
                </p>
              </div>
