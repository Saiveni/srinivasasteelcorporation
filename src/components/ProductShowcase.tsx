      ...
      <div className="relative w-full h-full transition-all duration-700 preserve-3d group-hover:rotate-y-12">
        ...
        <div className="absolute inset-0 bg-white rounded-[24px] border border-black/[0.04] shadow-[0_8px_32px_rgba(0,0,0,0.03)] overflow-hidden flex flex-col">
          ...
          <div className="absolute top-6 right-8 z-20">
            <span className="text-[10px] font-body font-bold text-[#C5A059] tracking-[0.3em] opacity-60">
              {product.index}
            </span>
          </div>
          ...
          <div className="flex-1 p-8 relative">
            ...
            <div className="inline-block px-3 py-1 rounded-full bg-[#C5A059]/10 mb-4">
              <span className="text-[9px] font-body font-bold text-[#C5A059] uppercase tracking-widest">
                PREMIUM GRADE
              </span>
            </div>
      ...
      <div className="container-wide relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 lg:mb-24 gap-8">
          <div className="max-w-[620px]">
            ...
            >
              <span className="text-[#C5A059] text-[12px] lg:text-[13px] font-body font-bold uppercase tracking-[0.25em] mb-4 block">
                CATALOGUE
              </span>
          ...
          >
            ...
            <span className="text-[11px] font-body uppercase tracking-[0.2em] text-[#C5A059]/60 font-bold">EST. 1994</span>
          </motion.div>
        </div>
