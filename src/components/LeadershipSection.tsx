...
export const LeadershipSection = () => {
  return (
    <section id="leadership" className="relative py-24 lg:py-32 bg-[#0F1621] overflow-visible z-10">
      ...
      <div className="container-wide relative z-10 mx-auto pt-16 sm:pt-20">
