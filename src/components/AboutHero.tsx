          ...
          >
            ...
            <div className="w-full lg:w-[52%] text-left">
              ...
              <div className="mb-8 overflow-hidden">
                <motion.h1
                  ...
                  className="text-h1 text-ssc-on-dark-primary mb-8 uppercase"
                >
                  BUILT ON STEEL. <br />
              ...
              <motion.div
                ...
                className="flex flex-wrap items-center gap-x-5 gap-y-2 mb-8 pb-6 border-b border-ssc-on-dark-primary/10"
              >
              ...
              <motion.div variants={itemVariants} className="max-w-xl">
                <p className="text-ssc-on-dark-body text-body-large mb-10">
                ...
                <div className="flex items-center gap-8 lg:gap-10">
                  <div className="flex flex-col">
                    <span className="text-h3 text-ssc-on-dark-primary">30+</span>
                    <span className="text-ssc-gold text-micro mt-1">Years Experience</span>
                  </div>
                  <div className="w-[1px] h-12 bg-ssc-on-dark-primary/10" />
                  <div className="flex flex-col">
                    <span className="text-h3 text-ssc-on-dark-primary">3</span>
                    <span className="text-ssc-gold text-micro mt-1">Regional Yards</span>
                  </div>
                  <div className="w-[1px] h-12 bg-ssc-on-dark-primary/10" />
                  <div className="flex flex-col">
                    <span className="text-h3 text-ssc-gold">MoU</span>
                    <span className="text-ssc-gold text-micro mt-1">Dealer Status</span>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="w-full lg:w-[48%] relative">
              <motion.div
                ...
                className="relative aspect-[4/3] lg:aspect-[1.15/1] rounded-[24px] overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.6)] border border-ssc-on-dark-primary/10"
              >
                <img
