    ...
    <footer className="bg-background text-white pt-20 pb-10">
      <div className="container-wide">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-3">
              ...
              <div className="flex flex-col border-l border-white/10 pl-4 py-1">
                <span className="text-h4 font-bold tracking-[0.05em] leading-none uppercase text-white">
                  SRINIVASA <span className="font-medium opacity-80">STEEL</span>
                </span>
                <span className="text-micro text-primary leading-none mt-2 uppercase">
                  CORPORATION
                </span>
              </div>
            </Link>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-micro text-primary uppercase mb-6">Quick Links</h4>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-micro text-primary uppercase mb-6">Contact Us</h4>
            <ul className="space-y-4 text-white/70">
              <li className="flex gap-3">
                <MapPin className="text-primary shrink-0" size={20} />
                <div className="flex flex-col">
                  <span className="text-small font-bold text-white mb-1 uppercase">Head Office</span>
          ...
          {/* Trusted Partners */}
          <div>
            <h4 className="text-micro text-primary uppercase mb-6">Our Partners</h4>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col items-center md:items-start">
            <p className="text-small font-bold text-white tracking-[0.1em] uppercase">SRINIVASA STEEL CORPORATION</p>
