  ...
  return (
    <section className="w-full relative z-20 bg-[#0A121E] section-spacing overflow-hidden border-t border-white/5">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-[0.03]">
        ...
        <div className="absolute top-1/2 left-0 w-full h-[1px] bg-white/20 flex justify-between px-20">
          {[...Array(12)].map((_, i) => (
            <div key={i} className="w-[1px] h-4 bg-white/40 -mt-2" />
          ))}
        </div>
      </div>
      ...
      <div className="container-wide relative">
        <motion.div
          ...
          className="relative w-full mx-auto backdrop-blur-2xl bg-white/[0.03] rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] border border-white/10 overflow-hidden"
        >
          ...
          <div className="px-8 py-12 lg:px-16 lg:py-20">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-12 lg:gap-y-0 relative">
              {/* Dividers */}
              <div className="hidden lg:block absolute left-1/4 top-0 bottom-0 w-[1px] bg-white/5" />
              <div className="hidden lg:block absolute left-2/4 top-0 bottom-0 w-[1px] bg-white/5" />
              <div className="hidden lg:block absolute left-3/4 top-0 bottom-0 w-[1px] bg-white/5" />
